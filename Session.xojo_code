...
Inherits WebSession
	#tag Method, Flags = &h0
		Function dummyLoginProcess(username as string, password as string) As string
		  // sample login code
		  
		  if username.Uppercase = "TEST" and password.Uppercase = "TEST" then
		    return ""
		  else
		    return "credentials not approved"
		  end if
